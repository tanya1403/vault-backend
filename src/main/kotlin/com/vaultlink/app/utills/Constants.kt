...
const val LMS_ORD_ID = "homefirstlms"
const val KAISYS = "KAISYS";
...
const val CAMPAIGN_DETAILS = "CampaignDetails"
...
const val CONTENT_TYPE_APPLICATION_FORM_URLENCODED = "application/x-www-form-urlencoded"
...
const val BEARER_KEY = "to0zlYtxi_nQSndk90dfhd"
const val BEARER_SALT = "nhi44jdnQQQvvUBH7_S78dhjGHh"
...
const val DEFAULT_BRANCH_OWNER_ID = "0052j000000mA04AAE"
const val DEFAULT_BRANCH_OWNER_NAME = "Sudhish Sasidharan"
const val DEFAULT_BRANCH_OWNER_EMAIL = "sudhish.sasidharan@homefirstindia.com"
const val DEFAULT_BRANCH_OWNER_MOBILE_NO = "9892484987"

const val NO_CREDIT_SCORE = -59
const val BULK_THRESHOLD_VALUE = 100000
const val PRODUCTIVITY_EXPORT_VALUE = 100000
const val NO_DECIMAL_NUMBER = -1.0
const val NO_NUMBER = -1
const val MAXIMUM_BATCH_SIZE_500 = 500
const val LOAN_AMOUNT_THRESHOLD = 300000
...
const val CHINMAY_EMAIL_ID= "chinmay.joshi@homefirstindia.com"
const val SAGAR_EMAIL_ID= "sagar.ingale@homefirstindia.com"
const val VILASINI_EMAIL_ID= "tanya.khurana@homefirstindia.com"
const val ANGELA_EMAIL_ID= "angela.anil@homefirstindia.com"
const val SWATI_EMAIL_ID ="swati.ganesh@homefirstindia.com"
const val JEKIN_EMAIL_ID ="jekin.shah@homefirstindia.com"
const val SECURITY_INFO = "securityInfo"
const val LEAD_EXPORT_REQUEST = "LMSLeadExport"
const val PRODUCTIVITY_DASHBOARD_REQUEST ="LMSProductivityUserStatExport"
const val PRODUCTIVITY_ALL_USER_REQUEST ="LMSProductivityAllUserCallStatExport"
const val PRODUCTIVITY_USER_REQUEST ="LMSProductivityUserCallStatExport"
...
const val SANCTIONED_PLAN ="Municipality/Town Planning (TP)"
...
const val DATE_RANGE_VALIDATION_GUIDE = "The maximum date range is $MAX_DAY_RANGE days"
const val PROGRESSIVE_PREPARATION_TIME = 10L

val writeOnlyAPIServices = arrayListOf (
    "/cas/lead/v1/create",
    "/cas/task/v1/create",
    "/cas/lead/v1/addRemark",
    "/cas/lead/v1/update",
    "/cas/lead/v1/updateApplicant",
    "/cas/admin/v1/user.add",
    "/cas/lead/v1/bulkUpload",
    "/cas/admin/v1/user.update",
    "/cas/admin/v1/telephonyAgent.create",
    "/cas/admin/v1/user.enable",
    "/cas/admin/v1/user.disable",
    "cas/admin/v1/campaign.status",
    "/cas/admin/v1/Partner.status",
    "/cas/admin/v1/Role.add",
    "/cas/admin/v1/Role.update",
    "/cas/admin/v1/Team.add",
    "/cas/admin/v1/Team.update",
    "/cas/admin/v1/SalesGroup.add",
    "/cas/admin/v1/SalesGroup.update",
    "/cas/admin/v1/Partner.add",
    "/cas/admin/v1/Partner.update",
    "/cas/admin/v1/LeadSource.add",
    "/cas/admin/v1/LeadSource.update",
    "/cas/admin/v1/Campaign.add",
    "/cas/admin/v1/Campaign.update",
    "/cas/admin/v1/changeLeadSource",
    "/cas/admin/v1/password.reset",
    "/cas/admin/v1/Creds.add",
    "/cas/connector/v1/addRemark"
)
...
enum class EnLeadStage(val value:String) {
    ...
    BRANCH_PROSPECT("Branch Prospect");
...
//
//enum class EnDocumentType(val value: String, var bucketPath: EnS3BucketPath?, val attachmentType: AttachmentType?,
//                          val tag: EnDocumentTag?, val objectName: MyObject?) {
//    AADHAAR("Aadhaar", EnS3BucketPath.AADHAAR, AttachmentType.AADHAAR, EnDocumentTag.KYC, MyObject.KYC_DOCUMENT),
//    PAN("PAN", EnS3BucketPath.PAN, AttachmentType.PAN, EnDocumentTag.KYC, MyObject.KYC_DOCUMENT),
//    VOTER_ID("VoterId", EnS3BucketPath.VOTER_IMAGES, AttachmentType.VOTER_ID, EnDocumentTag.KYC, MyObject.KYC_DOCUMENT),
//    DRIVING_LICENCE("DrivingLicence", EnS3BucketPath.DRIVING_LICENCE_IMAGES, AttachmentType.DRIVING_LICENCE, EnDocumentTag.KYC, MyObject.KYC_DOCUMENT),
//    PASSPORT("Passport", EnS3BucketPath.PASSPORT_IMAGES, AttachmentType.PASSPORT, EnDocumentTag.KYC, MyObject.KYC_DOCUMENT),
//    PROPERTY_PICTURE("PropertyPicture", EnS3BucketPath.PROPERTY, AttachmentType.PROPERTY_PICTURE, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    PROPERTY_DOCUMENT_PICTURE("PropertyDocumentPicture", EnS3BucketPath.PROPERTY, null, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    SALE_DEED("SaleDeed", EnS3BucketPath.PROPERTY, AttachmentType.SALE_DEED, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    GIFT_DEED("GiftDeed", EnS3BucketPath.PROPERTY, AttachmentType.GIFT_DEED, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    LEASE_AGREEMENT("LeaseAgreement", EnS3BucketPath.PROPERTY, AttachmentType.LEASE_AGREEMENT, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    MORTGAGE_DEED("MortgageDeed", EnS3BucketPath.PROPERTY, AttachmentType.MORTGAGE_DEED, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    POWER_OF_ATTORNEY("PowerOfAttorney", EnS3BucketPath.PROPERTY, AttachmentType.POWER_OF_ATTORNEY, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    PROPERTY_OTHERS("PropertyOthers", EnS3BucketPath.PROPERTY, AttachmentType.PROPERTY_OTHERS, EnDocumentTag.PROPERTY, MyObject.PROPERTY),
//    SALARY_SLIP("SalarySlip", EnS3BucketPath.SALARY_SLIP, AttachmentType.SALARY_SLIP, EnDocumentTag.INCOME, MyObject.CONTACT),
//    FORM_16("Form16", EnS3BucketPath.FORM_16, AttachmentType.FORM_16, EnDocumentTag.INCOME, MyObject.CONTACT),
//    BANK_STATEMENT("BankStatement", EnS3BucketPath.BANK_ACCOUNT, AttachmentType.BANK_STATEMENT, EnDocumentTag.INCOME, MyObject.CONTACT),
//    PASS_BOOK("Passbook", EnS3BucketPath.BANK_ACCOUNT, AttachmentType.PASSBOOK, EnDocumentTag.INCOME, MyObject.CONTACT),
//    ITR("ITR", EnS3BucketPath.ITR, AttachmentType.ITR, EnDocumentTag.INCOME, MyObject.CONTACT),
//    IDV_DOCUMENT("IdvDocument", EnS3BucketPath.IDV_DOCS, AttachmentType.IDV_DOCUMENT, EnDocumentTag.BUREAU, MyObject.CONTACT),
//    CIBIL_DOCUMENT("CibilDocument", EnS3BucketPath.CIBIL_DOCS, AttachmentType.CIBIL_DOCUMENT, EnDocumentTag.BUREAU, MyObject.CONTACT),
//    OTHERS("Others", EnS3BucketPath.OTHERS, AttachmentType.OTHERS, null, null);
//
//    companion object {
//        fun get(value: String): EnDocumentType? {
//            return values().find { it.value == value }
//        }
//
//        fun get(attachmentType: AttachmentType): EnDocumentType? {
//            return values().find { it.attachmentType == attachmentType }
//        }
//
//        fun getDocumentTypes(tag: String): ArrayList<String> {
//            val docTypes = ArrayList<String>()
//            values().forEach {
//                if (it.tag?.value == tag) {
//                    docTypes.add(it.value)
//                }
//            }
//            return docTypes
//        }
...
enum class LeadDestination(val value: String) {
    SALESFORCE("Salesforce"), LEAD_SQUARED("LeadSquared"),
    SF_N_LSQ("SF_N_LSQ"), KAISYS("KAISYS");
...
enum class MyObject(val value: String) {
    ...
    CAS_SMS_TEMPLATE("cas_SMSTemplate"),
    USER_REQUEST("cas_UserRequest"),
    SMS_LOG("SMSLog"),
    WHATSAPP_LOG("wa_CustomerMessage"),
    WHATSAPP_PULSE("wa_PulseWhatsappMsg"),
    CONTACT("Contact"),
    NOTIFICATION_TOKEN("cas_NotificationToken"),
    NOTIFICATION("cas_Notification"),
    PROPERTY("Property"),
    HFO_CREDENTIAL("HFOCredential"),
    TELEPHONY_AGENT("cas_TelephonyAgent"),
    PROGRESSIVE_CAMPAIGN("cas_ProgressiveCampaign"),;
...
enum class AttachmentType(val value: String) {
    ...
    LMS_PRODUCTIVITY_USER_STAT_EXPORT("LMSProductivityUserStatExport"),
    LMS_PRODUCTIVITY_USER_CALL_STAT_EXPORT("LMSProductivityUserCallStatExport"),
    LMS_PRODUCTIVITY_ALL_USER_CALL_STAT_EXPORT("LMSProductivityAllUserCallStatExport"),
    ...
    PROPERTY_OTHERS("PropertyOthers");

    companion object {
        fun get(value: String): AttachmentType? {
            return AttachmentType.values().find { it.value == value }
        }
    }
...
enum class StateCode(val code: String, val stateName: String) {
    ...
    CHANDIGARH("04", "Chandigarh"), UTTARANCHAL("05", "Uttaranchal"),  UTTARAKHAND("05", "Uttarakhand"), HARYANA("06", "Haryana"), DELHI(
        "07",
        "Delhi"
    ),
    ...
    TELANGANA("36", "Telangana"), MAHARASHTRA2("37", "MAHARASHTRA"), JAMMU_KASHMIR2(
        "38", "Jammu And Kashmir"),
    APO_ADDRESS("99", "APO Address");
...
enum class EnIsHotLead(var value: String, var displayName: String, val generalStatus: String) {
    API("API", "API", "API"),
    WA(
        "WA",
        "WA",
    ...
    companion object {
        val filterStatus = arrayListOf (API.value, WA.value, UP.value)

        operator fun get(value: String?): EnIsHotLead? {
...
enum class EnLoanType(val value:String) {
    ...
    HOME_LOAN_BT_TOP_UP("Home Loan (BT) + Top Up"),
    NONE("None"),
    ...
    PLOT_LOAN("Plot Loan"),
    PLOT_LOAN_HL("Plot Loan + HL (SeCo)"),
    OWN_PLOT("Own Plot + HL (SeCo)"),
    LAP_REFINANCE("LAP-Refinance"),
    ...
    companion object {
        operator fun get(value: String): EnLoanType? {
            return EnLoanType.values().firstOrNull{ it.value == value }
        }
    }
...
const val MSG_FOOTER_CASH = "- Best Regards, HomeFirst"
...
enum class EnRole(val value: String) {
    ...
    companion object {
        ...
        val levelOneRoles = arrayListOf (VRM, VRO, CALL_CENTER_SPOC, CALL_CENTER_AGENT)

        fun isTeamRequired(role: String): Boolean = !superRoles.contains(valueOf(role))

        fun isLevelOneRole(role: String): Boolean = !levelOneRoles.contains(valueOf(role))

    }
}


enum class EnTeam(val value: String, val displayName: String, val teamId: Long) {
    DIGITAL("DIGITAL", "Digital", 1),
    STRATEGIC_ALLIANCE("STRATEGIC_ALLIANCE", "Strategic Alliance", 2),
    OFFLINE_MARKETING_SOUTH("OFFLINE_MARKETING_SOUTH", "Offline Marketing (South)", 3),
    OFFLINE_MARKETING_NORTH("OFFLINE_MARKETING_NORTH", "Offline Marketing (North),", 4),
...
enum class EnContactType(val value: String) {
    PRIMARY("primary"),
    SECONDARY("secondary")
}
...
enum class EnCallType(val value: String) {
    ...
    ANSWER("ANSWER"),
    TOTAL("TOTAL"),
    INHOUSEPROGRESSIVE("INHOUSE_PROGRESSIVE"),
}

enum class EnKAISYSCallType(val value: String) {
    KAISYS_OUTBOUND("KAISYS_OUTBOUND"),
    INBOUND("INBOUND"),
    MISSED("MISSED"),
    ANSWER("ANSWER"),
    TOTAL("TOTAL");
...
enum class EnFilterType(val value: String) {
    LEAD_ID("LEAD_ID"),
...
enum class EnLeadSource(val value:String) {
    ...
    OUTDOOR_AD("Outdoor Ad"),
    INBOUND_SA_ALLIANCE("Inbound Strategic alliance"),
    PHONE_PE("PhonePe"),
    BRANCH_OUTDOOR("Branch Outdoor");
}
...
enum class EnLeadDistributionType(val value: String) {
    LOCATION("LOCATION"),
...
enum class EnKycType(val value: String) {
    PAN("PAN"),
    AADHAAR("Aadhaar"),
    DRIVING_LICENCE("DrivingLicence"),
    VOTER_ID("VoterId"),
    ...
    companion object {
        val kycDocType = arrayListOf (PAN.value, AADHAAR.value, DRIVING_LICENCE.value, VOTER_ID.value, PASSPORT.value)

        operator fun get(value: String): EnKycType? {
            return EnKycType.values().firstOrNull() { it.value == value }
        }
    }
}
...
enum class EnKycOcrType(val value: String) {
    ...
    companion object {
        val kycDocOcrType = arrayListOf(
            AADHAAR_BACK.value, AADHAAR_FRONT_BOTTOM.value, AADHAAR_FRONT_TOP.value, PAN.value,
            VOTERID_BACK.value, VOTERID_FRONT_NEW.value, DL_FRONT.value, PASSPORT_FRONT.value, PASSPORT_BACK.value
        )

        operator fun get(value: String): EnKycType {
            return EnKycType.values().first { it.value == value }
        }
    }
}
...
enum class EnDocumentCategory(val value: String, val displayValue: String) {
    KYC_DOCUMENT("KYCDocument", "KYC Document"),
    BUREAU_REPORT("BureauReport", "Bureau Report"),
    INCOME("Income", "Income"),
    PROPERTY("Property", "Property");

    companion object {
        operator fun get(value: String): EnDocumentCategory? {
            for (category: EnDocumentCategory in EnDocumentCategory.values()) {
...
enum class EnTelephonyProvider(val value: String){
    OZONETEL("OZONETEL"),
    KALEYRA("KALEYRA"),
    KAISYS_PROGRESSIVE("KAISYS PROGRESSIVE");

    companion object {
        fun get(value: String?): EnTelephonyProvider? {
            return values().find { it.value == value }
        }
    }
...
enum class EnTelephonyAgentStatus(val value: String){
    READY("Ready"),
    PAUSE("Pause"),
}

enum class EnOzonetelAuthenticateStatus(val value: String){
    LOGIN("Login"),
    LOGOUT("Logout");
}

enum class EnCampaignMessageType(val value: String) {
    SMS("SMS"),
    WHATSAPP("WHATSAPP"),
}

enum class EnTemplateMedium(val value: String, val displayName: String) {
    SMS("SMS", "SMS"),
    WHATSAPP("WHATSAPP", "WhatsApp");

    companion object {
        fun get(value: String?): EnTemplateMedium? {
            return EnTemplateMedium.values().find { it.value == value }
        }
    }

}

enum class EnSOBStageName(val value: String, val progress: Int, val displayName: String){
    NOSTAGE("NoStage", -1, "No Stage"),
    STAGE1("Stage1", 1, "Stage 1"),
    STAGE2("Stage2", 2, "Stage 2"),
    STAGE3("Stage3", 3, "Stage 3"),
    STAGE4("Stage4", 4, "Stage 4"),
    STAGE5("Stage5", 5, "Stage 5");

    companion object {

        fun getDisplayName(progress: Int?): EnSOBStageName? {
            return EnSOBStageName.values().find { it.progress == progress }
        }
...
enum class EnBooleanObject(val value:Boolean, val displayName: String) {
    ENABLE(true,"YES"),
    DISABLE(false,"NO");

    companion object

    fun getDisplayName(value: String?): EnBooleanObject? {
        return EnBooleanObject.values().find { it.value }
    }
}

enum class EnProgressiveCallStatus(val value: String) {
    PENDING("PENDING"),
    IN_PROGRESS("IN_PROGRESS"),
    COMPLETED("COMPLETED")
}

enum class EnCampaignAction(val value: String) {
    START("START"),
    PAUSE("PAUSE"),
    RESUME("RESUME"),
    STOP("STOP"),
...
enum class EnCampaignStatus(val value: String) {
    CREATED("CREATED"),
    RUNNING("RUNNING"),
    PAUSED("PAUSED"),
    COMPLETED("COMPLETED")
...
enum class EnService(val value: String) {
    BUREAU("BUREAU"),
    NEAREST_LOCATION("NEAREST_LOCATION"),
    PRODUCTIVITY_LIVE("PRODUCTIVITY_LIVE_DATA")
}

enum class EnLeadTags(val value: String) {
    NO_PINCODE("No Pincode"),
    INVALID_PINCODE("Invalid Pincode"),
    NO_PINCODE_BRANCH_MATCH("No Pincode Branch Match"),
    IVR_DISCONNECTED("IVR Disconnected")
}
